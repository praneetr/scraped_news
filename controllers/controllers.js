...
// This will get the articles scraped and saved in db.
...
// To grab an article by it's ObjectId
router.get("/articles/:id", function (req, res) {
    console.log("ID to retrieve: " + req.params.id);
    Article.findOne({
            "_id": req.params.id
        })
        .populate('notes')
